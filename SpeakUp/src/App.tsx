...
function App() {
  ...
  return (
    <div className="text-center">
      ...
      <button className="transition ease-in-out border-black border px-3 py-1 hover:rounded-xl hover:scale-110 hover:font-special" onClick={() => setIsPastRecordingsModalOpen(true)}>View Past Recordings</button>
      
      <svg height="18em" className="mx-auto w-1/2 min-w-100 min-h-24" preserveAspectRatio="none">
        <defs>
