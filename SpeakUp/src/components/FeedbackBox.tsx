...
const App: React.FC<AppProps> = ({ feedback, audioURL }) => {
  console.log(feedback);
  console.log(feedback.fillerWords);
  return (
    <div className="text-white py-5 rounded-xl w-10/12 min-w-96 max-w-4xl mx-auto bg-gradient-to-r from-red-600 via-pink-600 to-purple-600">
      ...
      <div className="mx-auto my-6 px-12">
        <audio className="mx-auto" src={audioURL} controls={true}></audio>
      </div>
      <div className="my-6 px-12">
        <div className="inline-block w-3/12 text-left align-top">
          Transcript:{" "}
        </div>
        <div className="inline-block w-9/12 text-right align-top">
          {feedback.transcript}
        </div>
      </div>
      <div className="my-6 px-12">
      ...
      <div className="my-6 px-12">
        ...
        <div className="inline-block w-9/12 text-right align-top">
          {feedback.fillerWords &&
            feedback.fillerWords.map((fillerWord, index) => {
